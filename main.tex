...
Furthermore, it is important that these parameters comply with EASA Part-25 regulations for airfield performance. In particular, EASA states that in an engine failure situation, the minimum climb out angle for a large aeroplane is 1.38 $\degree$. This design phase is the final checkpoint for the aircraft designed for this project and will ultimately inform the design team if the design objectives have been met. After some mathematical analysis, the takeoff speed for the aircraft is found to be 44m/s and is found by Equation 4.X. 
\begin{equation}
